    ...
    <>      
        <div className='container'>
            ...
            <form onSubmit={handleSubmit}>
                <input type="text" className='form-style' value={newTask} onChange={e => setNewTask(e.target.value)} placeholder='Aggiungi un nuovo articolo' />
                <button className='btn btn-success autline'>Add</button>
            </form>
            </div>
